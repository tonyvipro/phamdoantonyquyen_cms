...
<style>
/* ========================================================
   FIT TDC SEARCH RESULTS - ĐỊNH DẠNG CHUẨN THEO ẢNH 1
   ======================================================== */
.fit-tdc-wrapper {
    max-width: 960px;
...
.fit-tdc-search-header {
    margin-bottom: 35px;
    padding-bottom: 15px;
    border-bottom: 2px solid #0b57a4;
}
.fit-tdc-search-header h1 {
    font-size: 26px;
    font-weight: 700;
    color: #0b57a4;
    margin: 0 0 8px 0;
...
<main id="site-content" class="fit-tdc-wrapper">
    ...
    <!-- Header kết quả tìm kiếm -->
    <header class="fit-tdc-search-header">
        <h1>
            Kết quả tìm kiếm
        </h1>
        <p>
            ...
            if ( $total_found > 0 ) {
                printf(
                    'Tìm thấy %d kết quả cho từ khóa: "%s"',
                    $total_found,
                    esc_html( $search_term )
                );
            } else {
                printf(
                    'Không tìm thấy kết quả nào cho từ khóa: "%s"',
                    esc_html( $search_term )
                );
            }
            ?>
    ...
    <!-- Danh sách bài viết tìm kiếm định dạng chuẩn FIT TDC -->
